...
export function Home() {
    ...
    return (
        <>
            <div className="text-6xl font-righteous font-medium bg-gradient-to-br from-[#F4F4F4] to-[#05C5D7] bg-clip-text text-transparent mx-auto flex justify-center mt-32 sm:mt-40 animate-reveal sm:text-6xl lg:text-7xl">
                <p>Sadia Khan</p>
            </div>
