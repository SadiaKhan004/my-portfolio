...
import { Orrery } from "./orbitexplorer";
export function Projects() {
  ...
  if (selectedPage === "vital") return <BloodDonation />;
  if (selectedPage === "Orrery") return <Orrery />;
    ...
    <>
      <div className="flex items-center justify-center mt-32">
        ...
        >
          ...
          className="bg-[#000C1C] rounded-3xl text-center text-[#05C5D7] w-60 h-70 transition-transform transform hover:-translate-y-5 shadow-custom3 pt-3 flex-shrink-0 lg:w-60 h-80">
            Blood Donation System
            <img
              src={"assets/VitalVeins1.jpg"}
          ...
          <div 
          onClick={() => handleCardClick("Orrery")}
          className="bg-[#000C1C] rounded-3xl text-center text-[#05C5D7] w-60 h-70 transition-transform transform hover:-translate-y-5 shadow-custom3 pt-3 flex-shrink-0 lg:w-60 h-80">
            Orrery Web Application
            <img
              src={"assets/orbitexp.png"}
